...
description: "Целевой экспресс-анализ конкретного аспекта кодовой базы с gap-анализом текущего состояния против желаемого. Используй когда пользователь просит изучить конкретную область проекта, понять как работает определённый модуль/фича, сравнить текущую реализацию с желаемой, или говорит 'изучи кодовую базу', 'экспресс-анализ', 'что сейчас есть по теме X'."
---
