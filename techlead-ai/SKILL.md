...
description: >
  ...
  Проверяет код на критичные баги, уязвимости (OWASP Top 10), производительность,
  поддерживаемость, соответствие Clean Code и SOLID. Используй проактивно сразу
  после написания или модификации кода, а также когда пользователь просит
  «сделай code review», «проверь код», «ревью изменений», «посмотри мой код»,
  «есть ли баги», «безопасен ли код».
---
